...
manufactures_url = {
    ...
    'generated': 'https://drive.google.com/file/d/1Sx8JvtWfOe-2A0cwalUwgL7HSDKuuSgl/view',
    'partly_generated': 'https://drive.google.com/file/d/1ZVC85dwQlIuwfO9ewqAWZbDg6fEvWSr5/view',
...
orders_url = {
    ...
    'generated' : 'https://drive.google.com/file/d/1xmf2PPpnFrnbCbrGoi0-udqd_9ciSvem/view',
...
print('Manufacturers\' dataset shape:', manufacturers_db.shape)

#orders dataset
orders_db = pd.read_csv('https://drive.google.com/uc?id=' + orders_url['original'].split('/')[-2])
print('Orders\' dataset shape:', orders_db.shape)
...
print(type(manufacturers_db))
# print('Order details:\n\n')
# order = clean_db(orders_db).iloc[order_id,:].dropna()
